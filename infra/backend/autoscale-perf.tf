...
resource "aws_cloudwatch_metric_alarm" "cpu_utilization_high" {
  alarm_name          = "${var.name}-${local.environment}-CPU-Utilization-High-${var.ecs_as_cpu_high_threshold_per}"
...
resource "aws_cloudwatch_metric_alarm" "cpu_utilization_low" {
  alarm_name          = "${var.name}-${local.environment}-CPU-Utilization-Low-${var.ecs_as_cpu_low_threshold_per}"
